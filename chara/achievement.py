...
from chara.models import CharaAchievement, CharaAchievementCounter, CharaAchievementType
...
def obtain_achievement(chara_id, category_id):
    ...
    if achivement_types:
        ...
        for achivement_type in achivement_types:
            send_info_message(chara_id, "success", f"獲得了「{achivement_type.name}」成就")
